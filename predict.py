...
class carpredictor:
    ...
    def find_carplate(self , img):
        ...
        #显示已处理图像
        plt.figure("image processing"),plt.subplot(331),plt.imshow(cv2.cvtColor(origin_img,cv2.COLOR_BGR2RGB)),plt.title("origin image"),plt.axis("off")
        plt.figure("image processing"),plt.subplot(332),plt.imshow(cv2.cvtColor(gauss_img,cv2.COLOR_BGR2RGB)),plt.title("gaussianblur image"),plt.axis("off")
        plt.figure("image processing"), plt.subplot(333), plt.imshow(gray_gauss_img,"gray"), plt.title("gray_gauss_img"),plt.axis("off")
        plt.figure("image processing"), plt.subplot(334), plt.imshow(gray_gauss_img, "gray"), plt.title("gray_gauss_img"),plt.axis("off")
        ...
        plt.figure("image processing_2"), plt.subplot(334), plt.imshow(cv2.cvtColor(draw_area_outline_img,cv2.COLOR_BGR2RGB)), plt.title("draw_area_outline_img"),plt.axis("off")
        plt.figure("image processing_2"), plt.subplot(335), plt.imshow(cv2.cvtColor(draw_area_rect_img, cv2.COLOR_BGR2RGB)), plt.title("draw_area_rect_img"),plt.axis("off")
        plt.figure("image processing_2"), plt.subplot(336), plt.imshow(cv2.cvtColor(draw_ratio_rect_img, cv2.COLOR_BGR2RGB)), plt.title("draw_ratio_rect_img"), plt.axis("off")
        plt.show()